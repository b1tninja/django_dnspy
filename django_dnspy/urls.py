...
from dnspy.views import NameDetailView, ResourceHeaderDetailView, ResourceRecordDetailView, QueryDetailView, PacketDetailView
...
urlpatterns = patterns('',
    ...
    url(r'^packets/$', ListView.as_view(model=Packet,), name='packet_list'),
    url(r'^packet/(?P<pk>\d+)/$', PacketDetailView.as_view(), name='packet'),
